...
function e = SLAM_CalcPredictionError( X )
    ...
    % 1. UVD error:
    e  = fn_CalcPredictionError_Zuv(RptFeatureObs, K, X, Zobs, nPoseNew, nPts, ImuTimestamps );

    % 2. IMU dlt error:
    ePreInt = fn_CalcPredictionError_ZintlDelta(X, Zobs, nPoseNew, nPts, SLAM_Params.bf0, ...
