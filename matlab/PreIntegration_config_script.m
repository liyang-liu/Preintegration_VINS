...
PreIntegration_options.bUseLevenburgMacquardt = 0;
...
if PreIntegration_options.bSimuNpose == 1
    ...
    PreIntegration_options.nPoses = 100;%10;%5;%15;%2;%3;%9;%2;%170;%4;%6;%120;%50;%10;%20;%60;%80;%13;%12;%170;% 200;%350;%30;%14;%60;%5;%40;%1000;%350;%15;%1200;%30;%170;%120;%7;%50;%120;%30;%60;%170;%
    ...
    PreIntegration_options.bIMUodo = 1;% Use IMU data to initilize x?: refers to frame orientation and translation
    ...
    PreIntegration_options.bTestIntegrity = 1;
    ...
    if ( PreIntegration_options.bSimData )
        ...
        PreIntegration_options.bUseNoisySensor = 0; %Apply gaussian noise to IMU and uvd data
    ...
    elseif ( PreIntegration_options.bMalaga )
        %     bPerfectIMUdlt = 1;   
        PreIntegration_options.kfspan = 10;%20;%1;%5;%15;%50;%30;%2;% Choose keyframes
...
elseif PreIntegration_options.bInc ==1
    ...
    PreIntegration_options.minFeatureParallax = 1;
    
    if ( PreIntegration_options.bSimData )
          PreIntegration_options.minFeatureParallax = 0.5
    elseif ( PreIntegration_options.bMalaga )
    %     bPerfectIMUdlt = 1;   
