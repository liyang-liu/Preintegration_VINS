function [pkf, vkf, phikf] = fnIMUstdEKF(imuData_cell, Ru_cell, Tu_cell,  vu, pidst, piden, SLAM_Params )
                %fnIMUstdEKF(imuData_cell, Ru_cell, Tu_cell, ...
...
% load([dataDir 'IMUdata_for_Youbing.mat']); % dataIMU: time step, rotation rate, acceleration
    ...
    for(pid=pidst:piden-1)
        ...
        while(k < nts)	
            ...
            [p, v, phi] = fnStdPredict(p, v, phi, dt, fb0, omega0, SLAM_Params.bf, SLAM_Params.bw, SLAM_Params.g );
