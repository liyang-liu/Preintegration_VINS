function [e] = fn_IMUdltErr(x, Zobs, nPoses, nPts, bf0, bw0, dt, J, nIMUrate )%g, 
...
if((PreIntegration_options.bPreInt == 1)) %... 
    % && ((PreIntegration_options.bAddZg == 1) || (PreIntegration_options.bAddZtu2c == 1)  || (PreIntegration_options.bAddZau2c == 1)|| (PreIntegration_options.bAddZantu2c == 1) || (PreIntegration_options.bAddZbf == 1)))
    id1x = (nPoses-1)*9+1;
