function [imuData_cell, uvd_cell, Ru_cell, Tu_cell, Ru2c, Tu2c] = ...
            fnSimIMUnFeaturesAtNPoses_line(nPoses, nPts, Ru2c, Tu2c, g)
...
dtang = (nPoses - 1) * pi / 50;%pi / ((nPoses - 1));%0;%3 * 
...
%         [x0, dataIMU] = fnSimuIMU(nsamplerate, dtang, T12(1), T12(2), T12(3), g, bConstV);
        [x0, dataIMU] = fnSimuIMU(nsamplerate, dtang, tT(1), tT(2), tT(3), g, bConstV);
