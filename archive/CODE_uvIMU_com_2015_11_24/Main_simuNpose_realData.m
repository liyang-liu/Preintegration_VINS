...
nPoses = 20;%10;%5;%15;%2;%3;%9;%2;%170;%4;%6;%120;%50;%10;%20;%60;%80;%13;%12;%170;% 200;%350;%30;%14;%60;%5;%40;%1000;%350;%15;%1200;%30;%170;%120;%7;%50;%120;%30;%60;%170;%
...
if(bMalaga == 1)
    ...
    % Directories
    datadir = ['../../Data/Malaga' filesep 'Whole170R' filesep 'Result' filesep];
    imgdir = ['../../Data/Malaga' filesep 'Whole170R' filesep];
    imufulldir = ['../../Data/Malaga' filesep 'IMUrawData.mat'];
    gtFile = ['../../Data/Malaga' filesep 'Whole170R' filesep 'GT_P0_PA.mat'];    
elseif(bDinuka == 1)
