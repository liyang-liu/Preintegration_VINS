function [fh] = fnShowIMUgtPoses(Ru_cell, Tu_cell, nPoses, nIMUrate, bPreInt, stitle)
...
if(bPreInt == 1)
    for(pid = 1:nPoses)
%         quiver3(Tu_cell{pid}(1), Tu_cell{pid}(2), Tu_cell{pid}(3), Ru_cell{pid}(1,1), Ru_cell{pid}(1,2), Ru_cell{pid}(1,3), ratio);
%         quiver3(Tu_cell{pid}(1), Tu_cell{pid}(2), Tu_cell{pid}(3), Ru_cell{pid}(2,1), Ru_cell{pid}(2,2), Ru_cell{pid}(2,3), ratio);
%         quiver3(Tu_cell{pid}(1), Tu_cell{pid}(2), Tu_cell{pid}(3), Ru_cell{pid}(3,1), Ru_cell{pid}(3,2), Ru_cell{pid}(3,3), ratio);
        plot3(Tu_cell{pid}(1), Tu_cell{pid}(2), Tu_cell{pid}(3), '--bo');
    end
end
