...
if(bSimData == 1)
    ...
    sigma_w_real = 0;%0.03; 
    sigma_f_real = 0;%0.2;%    
    sigma_w_cov = 1;%2*sigma_w_real;%1e-3; 
    sigma_f_cov = 1;%2*sigma_f_real;%1e-3;%0.0775; % Siga for the noises to be added to the IMU raw data (wi,ai)
    sigma_uov_real = 0;%1e-2;%1;% 
    sigma_uov_cov = 1;%2*sigma_uov_real;%
    sigma_d_real = 0;%
    sigma_d_cov = 0.1;
...
elseif(bDinuka == 1)
    ...
    % Directories
    datadir = ['../../Data' filesep 'Dinuka' filesep 'dataset_19_10_15' filesep];%Dinuka/dataset_19_10_15
    imgdir = datadir;
...
%--------------------------------
% Hack, test with Ground Truth as initial value
%---------------------------------
%x = xg;
% Show initial value
