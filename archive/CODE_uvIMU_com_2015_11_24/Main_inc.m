...
elseif(bMalaga == 1)
    ...
    bw_true = [1.0; 2.0; 3.0]; %[0, 0, 0]'; % bias for rotaion velocity     
    % Directories
    datadir = [ '../../Data' filesep 'Whole170R' filesep 'Result' filesep];
    imgdir = ['../../Data' filesep 'Whole170R' filesep];
    imufulldir = ['../../Data' filesep 'Malaga' filesep 'IMUrawData.mat'];
    gtFile = ['../../Data' filesep 'Whole170R' filesep 'GT_P0_PA.mat'];    
elseif(bDinuka == 1)
    ...
    % Directories
    datadir = ['../../Data' filesep 'Dinuka' filesep 'dataset_19_10_15' filesep];%dataset_19_10_15
    imgdir = datadir;
...
fLowerbound_e = 1e-5;%1e-10;%1e-6;%1e-5;%1e-1;
fLowerbound_dx = 1e-5;1e-10;%1e-6;%
...
%                     K, Feature3D, bMalaga, RptFeatureObs, Tu2c, Ru2c);
    ...
    %% Combine old and new poses into x        
            ...
            if(bPreInt == 1)
                ...
                tv = fnLinearInterpPoses_Inc(nPoseNew, nPoseOld, ABGimu, Timu, ...
                    ImuTimestamps);
                x(idstart:idend) = tv(:);
            end        
        end        
...
%                 end
    ...
    %     save('x_Jac.mat', 'xf');
        %% Show pose-feature graph
        if((bShowUncertainty == 1) && ((nPoseOld == 1) || (nPoseNew == nAllposes)))% bShowFnP == 1)
            fnShowFeaturesnPoses(xf, nPoseNew, nPts, nIMUrate, bPreInt, 'Final Values');
%         end
        %% Show uncertainty
%         if((bShowUncertainty == 1) && ((nPoseOld == 1) || (nPoseNew == nAllposes)))% 
