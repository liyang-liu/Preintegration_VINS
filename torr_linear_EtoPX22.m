...
function [P1,P2,R,t,rot_axis,rot_angle,g] = torr_linear_EtoPX22(E,matches,C,m3)
...
chieral1 = (sign(bx1(3,:) ) .* sign (X1(4,:))) +  (sign(X1(3,:) ) .* sign (X1(4,:)));
chieral2 = (sign(bx2(3,:) ) .* sign (X2(4,:))) +  (sign(X2(3,:) ) .* sign (X2(4,:)));
chieral3 = (sign(bx3(3,:) ) .* sign (X3(4,:))) +  (sign(X3(3,:) ) .* sign (X3(4,:)));
chieral4 = (sign(bx4(3,:) ) .* sign (X4(4,:))) +  (sign(X4(3,:) ) .* sign (X4(4,:)));
