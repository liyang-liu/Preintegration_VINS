function X_obj = XVector2Object( X_vec, X_obj )
    ...
    for i=1:numPose-1
        ...
        X_obj.pose(i).ang = X_vec( (i-1)*6 + 1 : (i-1)*6 + 3);
        X_obj.pose(i).trans = X_vec( (i-1)*6 + 4 : (i-1)*6 + 6);
    end
    ...
    X_obj.Au2c = X_vec(1:3);
    X_vec(1:3) = []; % delete
          
    X_obj.Tu2c = X_vec(1:3);
    X_vec(1:3) = []; % delete
