...
$$\textbf{Z}_{prn} = (\overbrace{\textbf{uv}_{1}, ... , \textbf{uv}_{N}, ..., \textbf{uv}_{1N}, ... , \textbf{uv}_{MN}}^{M \times N \times 3}, \overbrace{d\textbf{p}_2, d\textbf{v}_2, d\textbf{A}_2, ..., d\textbf{p}_N, d\textbf{v}_N, d\textbf{A}_N}^{(N - 1) \times 9})' $$
...
\begin{equation}
\triangle {\bm{I}}_k = \bm{f}( \bm{\triangle I_{k-1}}, \bm{f}^{\mathrm{b}}_{k}, \bm{\omega}^{\mathrm{b}}_{k})
\end{equation}
