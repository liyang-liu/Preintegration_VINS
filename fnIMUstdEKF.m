function [pkf, vkf, phikf] = fnIMUstdEKF(imuData_cell, Ru_cell, Tu_cell, ...
...
for(pid=pidst:piden-1)
    ...
    while(k < nts)	
        ...
        [p, v, phi] = fnStdPredict(p, v, phi, dt, fb0, omega0, bf, bw, gn);
    % 	P = fnStdCovPredict(Q, P, omega0, phi(:, k), dt, fb0, bf, bw)
        k = k + 1;
